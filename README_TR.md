...
| Ön koşul | Neden |
|---|---|
| Korunan tüm uygulamalar için **ortak bir üst alan adı**, `APPS_DOMAIN` olarak verilir | Oturum çerezi bunlar arasında paylaşılıyor; ilgisiz alan adlarındaki uygulamalar desteklenmiyor ([ADR-0015](docs/adr/0015-single-parent-domain.md)). Adı tek bir değişken koyuyor, kalan her şey onu okuyor — portal `portal.$APPS_DOMAIN`, Keycloak `auth.$APPS_DOMAIN` |
