...
| [docs/adr/](docs/adr/) | **Alınan kararlar** — 25 ADR: kapsam, PEP, OIDC, dil, ad, lisans, farklılaştırıcı, kesme hedefleri, uygulama kimliği, denetim saklama süresi, sürümleme, v1'de admin ekranı yok |
