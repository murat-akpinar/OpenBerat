...
| [docs/adr/](docs/adr/) | **Decisions taken** — 27 ADRs: scope, PEP, OIDC, language, name, licence, differentiator, revocation targets, application identity, audit retention, versioning, one read-only admin screen, no frontend framework |
