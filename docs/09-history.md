# 09 — Build log: how phases 0–7 closed
...
Open work is in [`TODO.md`](../TODO.md). Decisions are in [`adr/`](adr/).
...
- [ ] Backend on 2 instances + nginx health check (HA) — the one box left
      anywhere, and not a debt of this phase: N-06 puts it outside v1. It stays
      in [`TODO.md`](../TODO.md) with what measurement already knows about it.
